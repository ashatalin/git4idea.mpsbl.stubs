...
<solution name="git4idea.mpsbl.stubs" uuid="67007309-771c-4646-8d7f-68a04927a7a4" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    <modelRoot contentPath="${mps_home}/plugins/git4idea" type="java_classes">
      ...
      <sourceRoot location="lib/org.eclipse.jgit-2.1.0.201209190230-r.jar" />
  ...
  <facets>
    <facet pluginId="git4idea.bl.stubs" type="ideaPlugin" />
  </facets>
  <stubModelEntries>
    ...
    <stubModelEntry path="${mps_home}/plugins/git4idea/lib/org.eclipse.jgit-2.1.0.201209190230-r.jar" />
